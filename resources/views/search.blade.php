...
<body>
    ...
    <script>
        ...
        function search() {
            $.ajax({
                    url: `${baseURL}/search/multi?page=1&query=${searchKeyword}&api_key=${apiKey}`,
                    type: "get",
                    beforeSend: function() {
                        //Show Loader
                        $("#autoLoad").show();
                    ...
                    if (response.results) {
                        ...
                        response.results.forEach(item => {
                            ...
                            <div class="min-w-[232px] min-h-[428px] bg-white drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)] rounded-[32px] p-5 flex flex-col mr-8 duration-100">
                                ...
                                <span class="font-poppins font-bold text-xl mt-4 line-clamp-1 group-hover:line-clamp-none">${searchTitle}</span>
                                <span class="font-poppins text-sm mt-1">${searchYear}</span>
