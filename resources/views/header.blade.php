...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
    <div class="w-1/3 pl-10">
        <a href="/movies" class="uppercase text-base mx-5 text text-black hover:text-develobe-500 duration-200 font-poppins">Movies</a>
        <a href="/tv-shows" class="uppercase text-base mx-5 text text-black hover:text-develobe-500 duration-200 font-poppins">Tv Shows</a>
    </div>
    <div class=" w-1/3 flex items-center justify-center">
        <a href="/" class=" italic  font-bold text-5xl font-quicksand  text-develobe-500 hover:text-develobe-900 duration-200">CloudFlixx</a>
    </div>
    <div class="w-1/3 flex items-center justify-end pr-20">
        ...
        <a href="/login" class="text-base mx-5 text text-black hover:text-develobe-500 duration-200 font-poppins pl-5">Login</a>
        <a href="/register" class="text-base mx-5 text text-black hover:text-develobe-500 duration-200 font-poppins pr-6">Register</a>
    </div>
</div>