...
<head>
    ...
    <title>CloudFlixx 🚀 |Tv Shows Details</title>
    ...
    <div class="w-full h-screen flex flex-col relative">
        ...
        <div class="w-full bg-transparent h-[96px] drop-shadow-lg flex flex-row items-center z-10">
            <div class="w-1/3 pl-10">
                <a href="/movies" class="uppercase text-base mx-5 text text-white hover:text-develobe-500 duration-200 font-poppins">Movies</a>
                <a href="/tv-shows" class="uppercase text-base mx-5 text text-white hover:text-develobe-500 duration-200 font-poppins">Tv Shows</a>
            </div>
            <div class=" w-1/3 flex items-center justify-center">
                <a href="/" class=" italic  font-bold text-5xl font-quicksand  text-white hover:text-develobe-500 duration-200">CloudFlixx</a>
            </div>
            <div class="w-1/3 flex items-center justify-end pr-20">
                <a href="/search" class="group flex items-center justify-center ">
                ...
                <a href="/login" class="text-base mx-5 text text-white hover:text-develobe-500 duration-200 font-poppins pl-5">Login</a>
                <a href="/register" class="text-base mx-5 text text-white hover:text-develobe-500 duration-200 font-poppins pr-6">Register</a>
            </div>
        </div>
        ...
        <div class="w-full h-full z-10 flex flex-col justify-center px-20">
            ...
            <span class="font-poppins italic text-2xl mt-4 text-white max-w-3xl line-clamp-5">{{$tagline}}</span>
            ...
            <div class="flex flex-row mt-4 items-center">
                ...
                <div class="w-20 h-20 rounded-full flex items-center justify-center mr-4" style="background: #00304D;">
                    ...
                    <span class="absolute font-poppins font-bold text-xl text-white">{{$rating}}%</span>
                </div>

                <!-- Year -->
                <span class="font-poppins text-xl text-white bg-transparent rounded-md border border-white p-2 mr-4">{{$year}}</span>

                <!-- Duration -->
                @if($duration)
                <span class="font-poppins text-xl text-white bg-transparent rounded-md border border-white p-2">{{$duration}}</span>
                @endif
            </div>
            ...
            @if($trailerID)
            <button class="w-fit bg-develobe-500 text-white pl-4 pr-6 py-3 mt-5 font-poppins text-xl flex flex-row rounded-lg items-center hover:drop-shadow-lg duration-200" onclick="showTrailer(true)">
